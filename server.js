// ==========================================
// BİLGİ ÜSSÜ - FEN BİLİMLERİ ARENA (TAM KOD)
// ==========================================
...
// Maç sıfırlama / yeniden başlatma fonksiyonu
function maciSifirlaVeBaslat() {
    kalanMacSuresi = 300;
    macBittiMi = false;
    mermiler = [];
    
    // Oyuncuların skorlarını, canlarını ve konumlarını sıfırla/yeniden spawn et
        ...
        <!DOCTYPE html><html><head><title>Fen Bilimleri Chest Arena</title><style>
            ...
            <div id="podyumModal">
                ...
                <div style="display: flex; gap: 15px; margin-top: 20px;">
                    <button onclick="tekrarOynaIstegi()" style="padding:12px 25px; background:#2ed573; color:#fff; border:none; font-weight:bold; border-radius:6px; cursor:pointer; font-size:15px;">Tekrar Oyna ➔</button>
            ...
            <script>
                ...
                function tekrarOynaIstegi() {
                    socket.emit('tekrarOyna');
                }
                ...
                socket.on('arenaGuncelle', (data) => { 
                    ...
                    if (data.macBitti) {
                        ...
                        macBittiEkranAktif = false;
                        podyumModal.style.display = 'none';
                    }
                });
